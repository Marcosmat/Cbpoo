...
public class Cbpoo {
	...
	private Cbpoo() {
		...
		gc.setNome("General Chair");          //login do General Chair              
		gc.setSenha("12345");                   
		//****************************************************************
		
		pc = new ProgramChair();
		pc.setCpf("12345678998");          //cpf: 1 2 3 4 5 6 7 8 9 9 8  
		pc.setNome("Program Chair");    //login do Program Chair
		pc.setSenha("12345");
		
	}
	
	public static Cbpoo getInst() {
		if(instance == null) {
			instance = new Cbpoo();
		}
		return instance;
...
//*********************************************************************	
	...
	//************************************************
	public Membro buscarMembro(String cpf, String senha) {
...
//***********************************************************************
	...
	public Pessoa cadastro(String id) {
